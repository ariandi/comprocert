...
@section('title')
 {{ Menus::getLanguageString('idSurvey') }}
@endsection
...
<div class="container">
  <div class="row">
    <form method="post" action="{{ route('profile.analysissurvey.store', ['NodeID' => $NodeID]) }}" style="width: 100%;">
    {{csrf_field()}}
    <h2 style="margin-bottom: 20px;text-align:center;">{{ $data['nodeName'] }}</h2>
      ...
      <div class="col-md-12 p">
        ...
        <div class="pageinfo" style="width: 370px !important;">
          Showing {{ Menus::getLanguageString('idQuestion') }} from {{ $data['from'] }} to {{ $data['perPage'] }} 
          Of {{ $data['countData'] }} {{ Menus::getLanguageString('idQuestion') }}
        </div>
