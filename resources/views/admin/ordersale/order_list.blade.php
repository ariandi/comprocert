...
@section('title') Order Sale @endsection
	        		...
	        		<div class="panel-group">
				    	<div class="panel panel-default">
			                <div class="panel-body">
						        ...
						        @endif
			                   	<a href="{{ route('ordersale.create') }}" class="btn btn-primary form-group savelang pull-right">Create New Order</a>
			            	</div>
			            </div>
				  	</div>
				  	<div class="panel-group">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var table = $('#datatables').DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('ordersale.getDatatablesData') }}",
			columns: [
				{data: 'id', name: 'id'},
